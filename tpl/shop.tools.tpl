...
<!-- BEGIN: ROW -->
				<tr>
					...
					<td class="centerall {SHOP_ROW_ODDEVEN}">{SHOP_ROW_PAYERTOTAL}</td>
...
<!-- END: DETAILS -->
			...
			<ul class="choices textcenter">
				<!-- IF {PHP.usr.groups.5} --><li><a href="admin.php?m=config&n=edit&o=plug&p=shop" title="{PHP.L.shop_config}">{PHP.L.shop_config}</a></li><!-- ENDIF -->
				<li><a href="{SHOP_GENERATE_XML}&amp;file=tutby" title="Export files">Export for tut.by</a></li>
				<li><a href="{SHOP_GENERATE_XML}&amp;file=shopby" title="Export files">Export for shop.by</a></li>
				<li><a href="{SHOP_GENERATE_XML}&amp;file=allproducts" title="Export files">Export all goods</a></li>
			</ul>
		</div>
